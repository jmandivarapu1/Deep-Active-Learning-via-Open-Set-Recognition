...
def get_the_datasets(args):
    if args.dataset == 'cifar10':
        test_dataloader = data.DataLoader(
                datasets.CIFAR10(args.data_path, download=True, transform=cifar_transformer(), train=False),batch_size=args.batch_size, drop_last=False)
    ...
    return querry_dataloader,unlabeled_dataloader,val_dataloader,val_dataloader_set1,val_dataloader_set1
